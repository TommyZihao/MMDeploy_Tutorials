...
class EngineBuilder:
    ...
    def create_engine(
        ...
        with self.builder.build_engine(self.network,
                                       self.config) as engine, \
...
def main(args):
    ...
    builder.create_network(args.onnx, input_shapes=dict(
        input=dict(min_shape=[1, 3, 224, 224],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--calib_input",
                        help="The directory holding images to use for "
                             "calibration")
    parser.add_argument(
        "--calib_cache",
        default="./calibration.cache",
        help="The file path for INT8 calibration cache to use, default: "
             "./calibration.cache",
    )
    parser.add_argument(
        "--calib_num_images",
    ...
    parser.add_argument(
        "--calib_batch_size", default=8, type=int,
